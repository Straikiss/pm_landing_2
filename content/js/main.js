...
function changeLanguage() {
  ...
  learnImg1.style.background = "url('content/img/learn/" + browserLang + "/learn-1.png') no-repeat center";
  learnImg2.style.background = "url('content/img/learn/" + browserLang + "/learn-2.png') no-repeat center";
  missionImg.style.background = "url('content/img/learn/" + browserLang + "/learn-1.png') no-repeat center";
}
